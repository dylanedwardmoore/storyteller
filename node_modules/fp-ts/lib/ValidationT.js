...
function getValidationM(S, M) {
    ...
    return {
        ...
        alt: function (fa, that) {
            return M.chain(fa, function (e1) {
                return Either_1.isRight(e1) ? A.of(e1.right) : M.map(that(), function (e2) { return (Either_1.isLeft(e2) ? Either_1.left(S.concat(e1.left, e2.left)) : e2); });
            });
        }
    };
}
